...
var LoadingBar = forwardRef(
  ({
    ...
    const pressedContinuous = useRef({ active: false, refreshRate: 1e3 });
    const [pressedStaticStart, setStaticStartPressed] = useState({ active: false, value: 60 });
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className, style: { ...loaderStyle, ...style } }, shadow ? /* @__PURE__ */ React.createElement("div", { style: { ...shadowStyle, ...shadowStyleProp } }) : null)
    );
  }
);
var LoaderContext = React.createContext(void 0);
var LoadingBarContainer = ({
  children,
  props
}) => {
  const [hookProps, setProps] = useState(props || {});
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(LoadingBar, { ref, ...hookProps }),
    children
  );
};
...
export { LoadingBarContainer, LoadingBar as default, useLoadingBar };
